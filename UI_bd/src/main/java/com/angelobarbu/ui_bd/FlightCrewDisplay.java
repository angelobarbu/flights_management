 ...
 * @author Angelo
 */
public class FlightCrewDisplay extends javax.swing.JFrame {

    /**
     * Creates new form FlightCrewDisplay
     */
    ...
    */
    public ArrayList<Employees> getEmployeesList() {
        ...
        try {
            ...
            String selectQuery = "SELECT A.AngajatID, A.CompanieID, A.Nume, A.Prenume, A.CNP, A.Adresa, A.Oras, A.Tara, A.DataNasterii, A.Pozitie, A.Salariu FROM Angajati AS A " +
                                 "INNER JOIN (Zboruri AS Z INNER JOIN AngajatiZboruri AS AZ ON Z.ZborID = AZ.ZborID) " + 
                                 "ON A.AngajatID = AZ.AngajatID " +
    ...
    //introduce angajatii din lista in JTable si ii afiseaza
    public void showEmployees() {
        
        ArrayList<Employees> employeesList = getEmployeesList();
        DefaultTableModel model = (DefaultTableModel) displayFlightCrew.getModel();
    ...
    private void initComponents() {
        ...
        displayFlightCrew = new javax.swing.JTable();
        backToMenuButton = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("FLAssistant");

        displayFlightCrew.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(displayFlightCrew);
    ...
    private javax.swing.JTable displayFlightCrew;
